...
echo "[RAZOR] Logging to $LOG_FILE"
...
# Metro port selection (avoid interactive prompt + ensure adb reverse matches)
...
echo "[RAZOR] Using Metro port: $METRO_PORT"
...
npx expo start --dev-client --android --localhost --port "$METRO_PORT"
